#!/bin/bash -l
#SBATCH -N 1
#SBATCH -J ukesm1-0-ll_ssp585
#SBATCH -t 24:00:00
#SBATCH --partition=genoa,rome
#SBATCH --output=/projects/prjs1222/GLOBGM/run_simulation/model_job_scripts/slurmOut/ukesm1-0-ll_ssp585.out

source ${HOME}/.bashrc
mamba activate globgm

simulation=ukesm1-0-ll
