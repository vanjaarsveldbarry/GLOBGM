localrules: setup_simulation,prepare_model_partitioning,write_model_forcing_setup,setup_output,
            ...
            _setup_subRun5,modify_ini_conditions_subRun5,
            _setup_subRun6,modify_ini_conditions_subRun6,
import os
...
subRun2_start,subRun2_end,subRun2_label = 2030,2043,2
...
rule all:
    input:
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution1_wtd_subRun{subRun6_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution1_hds_subRun{subRun6_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution2_wtd_subRun{subRun6_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution2_hds_subRun{subRun6_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution3_wtd_subRun{subRun6_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution3_hds_subRun{subRun6_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution4_wtd_subRun{subRun6_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution4_hds_subRun{subRun6_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution1_wtd_subRun{subRun5_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution1_hds_subRun{subRun5_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution2_wtd_subRun{subRun5_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution2_hds_subRun{subRun5_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution3_wtd_subRun{subRun5_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution3_hds_subRun{subRun5_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution4_wtd_subRun{subRun5_label}",
        f"{SLURMDIR_TR}/4_post-processing/done_post_model_solution4_hds_subRun{subRun5_label}",
