...
try:
    from . import groundwater_MODFLOW as gw_modflow
except:
    pass
...
class Groundwater(object):
    ...
    def update_with_MODFLOW(self, landSurface, routing, currTimeStep):
        ...
        if self.coupleToDailyMODFLOW:
            ...
            self.used_HCLOSE = pcr.ifthen(self.landmask, pcr.scalar(self.gw_modflow.used_HCLOSE))
            self.used_RCLOSE = pcr.ifthen(self.landmask, pcr.scalar(self.gw_modflow.used_RCLOSE))
