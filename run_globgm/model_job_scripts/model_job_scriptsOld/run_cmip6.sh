...
for simulation in "${simulations[@]}"; do
    ...
    # Step 2: prepare_model_partitioning
    # mkdir -p $slurmDir_ss/02_prep_model_part
    ...
    # sbatch -o $slurmDir_ss/3_partition_and_write_model_input/m%a.out --array=1-20 $ss_write_input_script $ssModelRoot
    # sbatch -o $slurmDir_ss/3_partition_and_write_model_input/m%a.out --array=384 $ss_write_input_script $ssModelRoot
    ...
    # sbatch -o $slurmDir_tr/_2_preprocess_pcrglobwb/main.out  $tr_preprocess_script $trModelRoot $slurmDir_tr/_2_preprocess_pcrglobwb $start_year $end_year
