...
river_bed_conductance  = tools.read_from_tile_folder(tile_pcraster_map_folder = tile_pcraster_map_folder, pcraster_map_file_name = "bed_condutance_used.map", clone_map = clone_map, tmp_dir = tmp_dir)
