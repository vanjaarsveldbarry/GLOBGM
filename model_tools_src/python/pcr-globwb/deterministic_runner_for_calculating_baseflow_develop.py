...
for i_elev in range(0, 12+1):
    ...
    vars()['drain_conductance_elev_'+str(i_elev)] = tools.read_from_tile_folder(tile_pcraster_map_folder = tile_pcraster_map_folder, pcraster_map_file_name = "drain_conductance_" + str(i_elev) + ".map", clone_map = clone_map, tmp_dir = tmp_dir)
