...
# source_zarr_path = '/projects/prjs1222/globgm_output/reference_gswp3-w5e5/historical_with_pump/merged/hds.zarr'
...
# save_path = Path('/projects/prjs1222/temp/hds_5arcmin.nc')
...
ds = xr.open_dataset('/projects/prjs1222/temp/hds_5arcmin.nc')
