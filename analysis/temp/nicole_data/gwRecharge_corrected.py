...
data_path = Path('/projects/prjs1222/globgm_output/_backup/historical_with_pump/gswp3-w5e5/forcing_input')
yearly_savePath_temp = '/scratch-shared/globgm_nicole/gwRecharge_corrected_annual.zarr'
