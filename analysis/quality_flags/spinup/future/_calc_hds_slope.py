...
save_path=save_dir.parent / f'output/{start_year}/hds_slope.nc'
save_path.parent.mkdir(parents=True, exist_ok=True)

def _read_hds():
    ds_1 = xr.open_zarr('/projects/prjs1222/globgm_output/cmip6_runs/ipsl-cm6a-lr/historical/annual/hds.zarr')['l2_hds']
    ds_2 = xr.open_zarr('/projects/prjs1222/globgm_output/cmip6_runs/ipsl-cm6a-lr/ssp370/annual/hds.zarr')['l2_hds']
...
ds, lat_coords, lon_coords = _read_hds()
